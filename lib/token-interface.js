...
var tokenContractJSON = require('../app/assets/contracts/_FreeDom.json');
...
module.exports =  {
 ...
 async  update()
  ...
  getTokenContractAddress()
  {
    ...
    {
      return deployedContractInfo.networks.testnet.contracts._FreeDom.blockchain_address;
    }else if(this.pool_env == 'staging'){
      return deployedContractInfo.networks.staging.contracts._FreeDom.blockchain_address;
    }else{
      return deployedContractInfo.networks.mainnet.contracts._FreeDom.blockchain_address;
    }
